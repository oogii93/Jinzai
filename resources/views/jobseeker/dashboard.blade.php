...
<div class="container px-5 flex justify-normal gap-5">
    ...
    <div class="relative">
        <a href="{{ route('cv') }}" class="block hover:bg-yellow-100 rounded-xl px-2 py-2">
            <svg
            class="w-20 h-20"
            ...
            <span class="flex justify-center text-md font-semibold ">
                {{ __('Resume') }}
            </span>
        </a>
    ...
    <div class="relative">
        <a href="{{ route('profile.edit') }}" class="block hover:bg-yellow-100 rounded-xl px-2 py-2">
        <svg
        class="w-20 h-20"
    ...
    <div class="relative">
        <a href="{{ route('jobseeker.history') }}" class="block hover:bg-yellow-100 rounded-xl px-2 py-2">
            <svg
            class="w-20 h-20"
...
{{ __('Job seekers are required to upload a 2 to 4 minute video introducing themselves in Japanese.Upload that video here!!') }}
        <br>{{ __('Video limit is up to 100MB.') }}
    </p>
</div>
