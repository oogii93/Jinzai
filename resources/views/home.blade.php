...
{{-- <div class="bg-sky-400 min-h-screen p-8"> --}}
    ...
    <div id="job facility" class="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 bg-gray-100 ">
        ...
        <div class="text-center max-w-full mx-auto py-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-5 gap-8 p-4 rounded-lg mx-auto w-4/5">
                    <!-- Content goes here -->
                    <!-- Content goes here -->
                    <div class="w-50 flex flex-col items-center bg-white rounded-2xl py-3 transition-transform duration-300 hover:bg-yellow-200" style="height:150px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
                        ...
                        <span class="mt-2 text-lg font-semibold mb-2">{{ __('Nursing care') }}</span>
                </div>


                <div class="flex flex-col items-center bg-white rounded-2xl py-3 transition-transform duration-300 hover:bg-yellow-200" style="height:150px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
            ...
            <div class="container mt-5 ">
                <div class="grid grid-cols-1 sm:grid-cols-5 gap-10 p-4 rounded-lg mx-auto w-4/5">
        ...
        <div  id="job seeker" class="bg-green-400 min-h-screen p-8">
