                        ...
                        <a href="{{ route('main') }}"
                           class="relative block transform transition-all duration-300 hover:-translate-y-1">
                            <div class="flex flex-col items-center justify-center w-24 h-16 cursor-pointer bg-white border border-gray-200 hover:bg-gray-100 transition-all duration-300">
                                ...
                                <span class="mr-2 mt-1 text-gray-800 text-[11px] font-medium group-hover:text-blue-600 transition-colors duration-300">
                                    {{ __('Main') }}
                                </span>
                ...
                <li class="relative group list-none">
                    ...
                    <div class="absolute z-10 hidden bg-white divide-y divide-gray-100 shadow-lg group-hover:block top-full left-0">
                        ...
                        <a href="{{ route('categories.index') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('Category') }}</a>

                        <a href="{{ route('tags.index') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('Tag') }}</a>

                        <a href="{{ route('admin.user.index') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('User') }}</a>

                        <a href="{{ route('admin.company.index') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('Company') }}</a>

                        <a href="{{ route('admin.applications.index') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('Applications') }}</a>
                ...
                <li class="relative group list-none">
                    ...
                    <div class="absolute z-10 hidden bg-white divide-y divide-gray-100 shadow-lg group-hover:block top-full left-0">
                        ...
                        <a href="{{ route('dashboard') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('Dashboard') }}</a>
                        <a href="{{ route('profile.edit') }}"
                            class="block px-4 py-2 w-48 hover:bg-sky-500 hover:text-white transition duration-300">{{ __('MyPage') }}</a>
