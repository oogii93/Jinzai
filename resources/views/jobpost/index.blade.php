                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    <!-- Changed from categories.edit to jobpost.edit -->
                                    <a href="{{ route('jobpost.edit', $item->id) }}"
                                       class="text-indigo-600 hover:text-indigo-900">Edit</a>

                                    <!-- Changed from categories.destroy to jobpost.destroy -->
                                    <form action="{{ route('jobpost.destroy', $item->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
